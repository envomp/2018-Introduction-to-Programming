...
|____¿|"""
    ...
    def ask_move(self) -> Move:
        ...
        while True:
            try:
                command = input(f"{Color.Fg.cyan}Choose your next move! {Color.Fg.green} "
                                f"(Use {Color.Fg.light_blue}'help' {Color.Fg.green}for help) "
    ...
    def show_help(self):
        """Show help."""
        print(f"{Color.Fg.light_blue}help {Color.Fg.orange}-> "
              f"{Color.Fg.green}help {Color.Fg.light_green}(print help/commands to console)\n"
              f"{Color.Fg.light_blue}hit {Color.Fg.pink}(h) {Color.Fg.orange}-> "
              f"{Color.Fg.green}hit {Color.Fg.light_green} (get one more card)\n"
              f"{Color.Fg.light_blue}stand {Color.Fg.pink}(s) {Color.Fg.orange}-> "
              f"{Color.Fg.green}stand {Color.Fg.light_green}(stop getting more cards, give turn to next player)\n"
              f"{Color.Fg.light_blue}split {Color.Fg.pink}(x) {Color.Fg.orange}-> "
              f"{Color.Fg.green}split cards {Color.Fg.light_green}"
              f"(if you have 2 cards with same value you can split them to 2 different decks)\n"
              f"{Color.Fg.light_blue}double {Color.Fg.pink}(d) {Color.Fg.orange}-> "
              f"{Color.Fg.green}double down {Color.Fg.light_green}(double your bet and receive 1 last card)\n"
              f"{Color.Fg.light_blue}surrender {Color.Fg.pink}(q) {Color.Fg.orange}-> "
